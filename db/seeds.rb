...
f1 = Friendship.create(user_id: u1.id, friend_id: u2.id, accepted: true)
...
f9 = Friendship.create(user_id: u0.id, friend_id: u3.id, accepted: true)
...
f13 = Friendship.create(user_id: u0.id, friend_id: u7.id, accepted: true)
f14 = Friendship.create(user_id: u0.id, friend_id: u8.id, accepted: true)
f15 = Friendship.create(user_id: u0.id, friend_id: u9.id, accepted: true)
...
f18 = Friendship.create(user_id: u0.id, friend_id: u12.id, accepted: true)
f19 = Friendship.create(user_id: u0.id, friend_id: u13.id, accepted: true)
