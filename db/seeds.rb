...
f0 = Friendship.create(user_id: u1.id, friend_id: u0.id, accepted: true)
f1 = Friendship.create(user_id: u1.id, friend_id: u2.id, accepted: false)
f2 = Friendship.create(user_id: u1.id, friend_id: u3.id, accepted: false)
f3 = Friendship.create(user_id: u1.id, friend_id: u4.id, accepted: false)
f4 = Friendship.create(user_id: u1.id, friend_id: u5.id, accepted: false)
f5 = Friendship.create(user_id: u1.id, friend_id: u6.id, accepted: false)
f6 = Friendship.create(user_id: u1.id, friend_id: u7.id, accepted: false)
f7 = Friendship.create(user_id: u0.id, friend_id: u1.id, accepted: true)
f8 = Friendship.create(user_id: u0.id, friend_id: u2.id, accepted: false)
f9 = Friendship.create(user_id: u0.id, friend_id: u3.id, accepted: false)
f10 = Friendship.create(user_id: u0.id, friend_id: u4.id, accepted: false)
f11 = Friendship.create(user_id: u0.id, friend_id: u5.id, accepted: false)
f12 = Friendship.create(user_id: u0.id, friend_id: u6.id, accepted: false)
f13 = Friendship.create(user_id: u0.id, friend_id: u7.id, accepted: false)
f14 = Friendship.create(user_id: u0.id, friend_id: u8.id, accepted: false)
f15 = Friendship.create(user_id: u0.id, friend_id: u9.id, accepted: false)
f16 = Friendship.create(user_id: u0.id, friend_id: u10.id, accepted: false)
f17 = Friendship.create(user_id: u0.id, friend_id: u11.id, accepted: false)
...
f20 = Friendship.create(user_id: u0.id, friend_id: u14.id, accepted: false)
...
b8 = Bill.create(biller_id: u8.id, category: 'Uncategorized: General', description: 'Test expense', total_amount: 100.00)
...
p13 = Payment.create(user_id: u0.id, bill_id: b8.id, initial_amount: 100.00, paid_amount: 99.00)
